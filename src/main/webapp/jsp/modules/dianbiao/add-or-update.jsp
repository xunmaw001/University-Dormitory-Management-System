            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑电表</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="susheId" name="susheId" type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>电表余额</label>
                                        <input id="dianbiaoMoney" name="dianbiaoMoney" class="form-control"
                                               onchange="dianbiaoMoneyChickValue(this)" placeholder="电表余额">
                                    </div>
...
<script>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                ...
                dianbiaoMoney: "required",
            },
            messages: {
                susheId: "宿舍不能为空",
                dianbiaoNumber: "电表编号不能为空",
                dianbiaoMoney: "电表余额不能为空",
            }
        }).form();
    }
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#dianbiaoMoney").val(ruleForm.dianbiaoMoney);
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            $(".aaaaaa").remove();
            // 电表余额设置不可选
            $('#dianbiaoMoney').attr('readonly', 'readonly');
        }
    }
