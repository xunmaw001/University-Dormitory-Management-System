                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    <div class="form-group col-md-6">
                                        <label>物品</label>
                                        <input id="wupin" name="wupin" class="form-control"
                                               placeholder="物品">
                                    </div>
                                    <div class="form-group  col-md-6">
                                        <label>报修详情</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>是否维修</label>
                                        <select id="baoxiuTypesSelect" name="baoxiuTypes" class="form-control">
                                        </select>
                                    </div>
...
<script>
    ...
    function getContent() {
        ...
        if($("#baoxiuContentupload").length>0) {
            ...
            if (baoxiuContentEditor.hasContents()) {
                $('#baoxiuContent-input').attr('value', baoxiuContentEditor.getPlainTxt());
            }
        }
    }
    //数字检查
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            //$('#wupin').attr('readonly', 'readonly');
            //$('#role').attr('style', 'pointer-events: none;');
        }else{
            $(".aaaaaa").remove();
            if(window.sessionStorage.getItem('addbaoxiu') != null && window.sessionStorage.getItem('addbaoxiu') !=""){//新增查询,修改不查
                // 查询当前登录账户的信息
                var userId = window.sessionStorage.getItem('userId');
                    yonghuSelectOne(userId);
            }
            if(window.sessionStorage.getItem('role') == '用户'){
                $('#baoxiuTypesSelect').attr('readonly', 'readonly');
                $('#baoxiuTypesSelect').attr('style', 'pointer-events: none;');
            }else if(window.sessionStorage.getItem('role') == '宿舍管理员'){
                var baoxiuContentEditor = UE.getEditor('baoxiuContentEditor');
                baoxiuContentEditor.ready(function () {
                    baoxiuContentEditor.setDisabled('fullscreen');
                });
                $('#wupin').attr('readonly', 'readonly');
            }
        }
