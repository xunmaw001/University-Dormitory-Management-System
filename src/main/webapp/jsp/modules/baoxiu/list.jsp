...
<!--/Pre Loader -->
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="wupinSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="物品" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //物品
            var wupinSearchInput = $('#wupinSearch');
            if( wupinSearchInput != null){
                if (wupinSearchInput.val() != null && wupinSearchInput.val() != '') {
                    searchForm.wupin = $('#wupinSearch').val();
                }
            }
                            getDataList();
        }
        ...
        function setDataRow(item, number) {
            ...
            //物品
            var wupinCell = document.createElement('td');
            wupinCell.innerHTML = item.wupin;
            row.appendChild(wupinCell);
            ...
            row.appendChild(insertTimeCell);
                ...
                //报修详情
            var baoxiuContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.baoxiuContent && item.baoxiuContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.baoxiuContent.indexOf('<img');
                var endIndex = item.baoxiuContent.indexOf('>');
                    baoxiuContentCell.innerHTML = item.baoxiuContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.baoxiuContent != null && item.baoxiuContent != "" && item.baoxiuContent.length >= 11) {
                        baoxiuContentCell.innerHTML = item.baoxiuContent.substring(0, 10) + "...";
                } else {
                        baoxiuContentCell.innerHTML = item.baoxiuContent;
                }
            }
            row.appendChild(baoxiuContentCell);
