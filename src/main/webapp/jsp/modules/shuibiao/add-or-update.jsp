            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑水表</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="susheId" name="susheId" type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="shuibiaoMoney" name="shuibiaoMoney" class="form-control"
                                               onchange="shuibiaoMoneyChickValue(this)" placeholder="水表余额">
                                    </div>
...
<script>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                ...
                shuibiaoMoney: "required",
            },
            messages: {
                susheId: "宿舍不能为空",
                shuibiaoNumber: "水表编号不能为空",
                shuibiaoMoney: "水表余额不能为空",
            }
        }).form();
    }
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            $(".aaaaaa").remove();
            // 水表余额设置不可选
            $('#shuibiaoMoney').attr('readonly', 'readonly');
        }
    }
