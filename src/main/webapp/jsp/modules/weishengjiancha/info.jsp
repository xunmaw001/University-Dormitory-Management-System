            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">卫生检查登记</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="susheId" name="susheId" v-model="ruleForm.susheId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>检查日期</label>
                                        <input id="weishengjianchaTime" name="weishengjianchaTime" class="form-control"
                                               v-model="ruleForm.weishengjianchaTime" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>检查结果</label>
                                    <input id="weishengjianchaValue" name="weishengjianchaValue" class="form-control"
                                           v-model="ruleForm.weishengjianchaValue" readonly>
                                </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "weishengjiancha/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.weishengjianchaContent != null && ruleForm.weishengjianchaContent != 'null' && ruleForm.weishengjianchaContent != '') {
            var weishengjianchaContentUeditor = UE.getEditor('weishengjianchaContentEditor');
                weishengjianchaContentUeditor.ready(function () {
                    var mes = '' + ruleForm.weishengjianchaContent;
                    weishengjianchaContentUeditor.setContent(mes);
                    weishengjianchaContentUeditor.setDisabled('fullscreen');
            });
        }
    }
