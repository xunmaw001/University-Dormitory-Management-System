            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">访客登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="fangkeName" name="fangkeName" class="form-control"
                                               v-model="ruleForm.fangkeName" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="fangkePhone" name="fangkePhone" class="form-control"
                                               v-model="ruleForm.fangkePhone" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="fangkeIdNumber" name="fangkeIdNumber" class="form-control"
                                               v-model="ruleForm.fangkeIdNumber" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="fangkeWendu" name="fangkeWendu" class="form-control"
                                               v-model="ruleForm.fangkeWendu" readonly>
                                    </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.fangkeContent != null && ruleForm.fangkeContent != 'null' && ruleForm.fangkeContent != '') {
            var fangkeContentUeditor = UE.getEditor('fangkeContentEditor');
                fangkeContentUeditor.ready(function () {
                    var mes = '' + ruleForm.fangkeContent;
                    fangkeContentUeditor.setContent(mes);
                    fangkeContentUeditor.setDisabled('fullscreen');
            });
        }
    }
